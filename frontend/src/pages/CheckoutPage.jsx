...
const CheckoutPage = () => {
    ...
    return (
        <motion.div
            ...
            className="min-h-screen bg-[#fafafa] dark:bg-gray-950 text-gray-900 dark:text-gray-100 antialiased transition-colors duration-300 pb-20 w-full"
        >
            <div className="container mx-auto px-4 py-6 sm:py-8 lg:py-12 max-w-7xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {currentStep === 1 && (
                                ...
                                >
                                    ...
                                    <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 space-y-6 shadow-sm">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                                                <FiUser className="w-4 h-4 text-gray-900 dark:text-white" />
                                                <span className="text-sm font-bold text-gray-900 dark:text-white flex-1 line-clamp-1">
                                                    {user?.name || 'Authenticated Patron'}
                                                </span>
                                                <span className="text-[10px] font-black uppercase text-gray-900 dark:text-white bg-gray-200 dark:bg-gray-700 px-2 py-0.5 rounded">
                                                    Verified User
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white text-sm font-semibold placeholder-gray-400 focus:outline-none focus:border-black dark:focus:border-white transition"
                                                    required
                                                />
                                            </div>
                                    ...
                                    <div className="flex gap-4 pt-4">
                                        <motion.button
                                            ...
                                            className="w-1/3 h-12 sm:h-14 rounded-2xl border border-gray-200 dark:border-gray-800 text-xs font-bold uppercase tracking-wider text-gray-500 hover:text-gray-900 dark:hover:text-white transition bg-white dark:bg-gray-900"
                                        >
                                            Back
                                        </motion.button>
                                        ...
                                        <motion.button
                                            ...
                                            className="flex-1 h-12 sm:h-14 bg-black dark:bg-white text-white dark:text-black font-bold rounded-2xl shadow-xl hover:shadow-2xl transition flex items-center justify-center gap-2"
                                        >
                                ...
                                >
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1 space-y-1">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <FiCheckCircle className={`w-5 h-5 ${paymentMethod === 'COD' ? 'text-black dark:text-white' : 'text-gray-300 dark:text-gray-700'}`} />
                                                    </div>
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1 space-y-1">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <FiCheckCircle className={`w-5 h-5 ${paymentMethod === 'Online Payment (Razorpay)' ? 'text-black dark:text-white' : 'text-gray-300 dark:text-gray-700'}`} />
                                                    </div>
                                                    <p className="text-xs text-gray-500 leading-relaxed">
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1 space-y-1">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <FiCheckCircle className={`w-5 h-5 ${paymentMethod === 'Net Banking' ? 'text-black dark:text-white' : 'text-gray-300 dark:text-gray-700'}`} />
                                                    </div>
                                                    <p className="text-xs text-gray-500 leading-relaxed">
                                    ...
                                    <div className="flex gap-4 pt-4">
                                        <motion.button
                                            ...
                                            className="w-1/3 h-14 rounded-2xl border border-gray-200 dark:border-gray-800 text-xs font-bold uppercase tracking-wider text-gray-500 hover:text-gray-900 dark:hover:text-white transition bg-white dark:bg-gray-900"
                                        >
                                            Back
                                        </motion.button>
                                        ...
                                        <motion.button
                                            ...
                                            whileTap="tap"
                                            onClick={handleNextStep}
                                            className="flex-1 h-14 bg-black dark:bg-white text-white dark:text-black font-bold rounded-2xl shadow-xl hover:shadow-2xl transition flex items-center justify-center gap-2"
                                        >
                            ...
                            {currentStep === 3 && (
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div className="p-5 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 space-y-2">
                                            <div className="flex justify-between items-center">
                                                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">
                                                    Delivery Details
                                                </span>
                                                <button onClick={() => setCurrentStep(1)} className="text-xs font-bold text-black dark:text-white hover:underline">
                                                    Edit
                                                </button>
                                            </div>
                                        ...
                                        <div className="p-5 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 space-y-2">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <button onClick={() => setCurrentStep(2)} className="text-xs font-bold text-black dark:text-white hover:underline">
                                                    Edit
                                                </button>
                                            </div>
                    ...
                    >
                        ...
                        <div className="p-4 sm:p-6 md:p-8 rounded-3xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 space-y-5 sm:space-y-6 shadow-sm">
                            ...
                            <div className="space-y-4 max-h-72 overflow-y-auto pr-1 custom-scrollbar pb-2">
                                {cartItems?.map((item) => (
                                    <div key={item.product} className="flex items-center gap-3 bg-white dark:bg-gray-800 p-3 rounded-2xl border border-gray-200 dark:border-gray-700">
                            ...
                            <div className="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-800 text-sm">
                                ...
                                <div className="flex justify-between items-center text-gray-500">
                                    ...
                                    <span className={`font-bold ${shippingPrice === 0 ? 'text-green-600 dark:text-emerald-400' : 'text-gray-900 dark:text-white'}`}>
                        ...
                        <div className="text-center">
                            <Link to="/cart" className="text-xs font-bold text-gray-500 hover:text-gray-900 dark:hover:text-white transition underline block">
                                Return to cart
                            </Link>
                        </div>
